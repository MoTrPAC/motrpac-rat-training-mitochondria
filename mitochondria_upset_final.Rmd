...
write.table(df_final,file.path(config$outdir_scratch,paste0("test_df_final_for_upset.tsv")),row.names=FALSE,quote=F,sep="\t")
...
pdf(file=file.path(config$outdir_scratch,paste0("upset_significant_mito_genes_training_rnaseq_subset_min6.pdf")),width=12,height=6)
...
#remove duplicate rows with identical feature_ids
df_final=distinct(df_final)
write.table(df_final,file.path(config$outdir_scratch,paste0("test_df_final_for_upset_prot.tsv")),row.names=FALSE,quote=F,sep="\t")
...
pdf(file=file.path(outdir_scratch,paste0("upset_significant_mito_genes_training_prot_subset_min3.pdf")),width=12,height=6)
