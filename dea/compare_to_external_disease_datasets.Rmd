...
add_overlap_tests_and_enrichments<-function(
  ...
  datasetname,tissue,
  min_size_for_sign_analysis = 10,
  fdr_motrpac=0.1,fdr_external=0.1,
...
barplot(
  ...
  col = TISSUE_COLORS[c("SKM-GN","LIVER","LIVER","LIVER")],
  names.arg = gsub(" et al.","",dataset_overlap_stats[dataset_overlap_stats$sex=="p","name"]),
...
barplot(
  dataset_overlap_stats[dataset_overlap_stats$sex!="p","log10P"],
  col = TISSUE_COLORS[c(rep("SKM-GN",4),rep("LIVER",10))],
  las=2,
