...
pls_before = plot_cluster_trajectories(clustering_analysis_matrix1[,1:8],cluster_res)
...
pls_after = plot_cluster_trajectories(clustering_analysis_matrix2[,1:8],cluster_res)
library(gridExtra)
pls = list()
...
write.csv(
  cluster_res,
  file = paste0(output_dir,"clustering_results.csv"),
  row.names = F,quote = F
)
